...
<div class="row-fluid">
	<div class="span12 text-center">
		<h3> Invited Speakers </h2>
	</div><!--/span-->
</div><!--/row-->
<div class="row-fluid">
	<div class="span12">
		<h4 class="text-center"> Group 1: Medical Ultrasonics </h4>
	</div>
</div><!--/row-->
<div class="row-fluid well">
	<p>Information coming soon.
...
<div class="row-fluid">
	<div class="span12">
		<h4 class="text-center"> Group 2: Sensors, NDE & Industrial Applications </h4>
	</div>
</div><!--/row-->
<div class="row-fluid well">
	<p>Information coming soon.
...
<div class="row-fluid">
	<div class="span12">
		<h4 class="text-center"> Group 3: Physical Acoustics </h4>
	</div>
</div><!--/row-->
<div class="row-fluid well">
	<p>Information coming soon.
...
<div class="row-fluid">
	<div class="span12">
		<h4 class="text-center"> Group 4: Microacoustics: SAW, FBAR, MEMS </h4>
	</div>
</div><!--/row-->
<div class="row-fluid well">
	<p>Information coming soon.
...
<div class="row-fluid">
	<div class="span12">
		<h4 class="text-center"> Group 5: Transducers & Transducer Materials </h4>
	</div>
</div><!--/row-->
<div class="row-fluid well">
	<p>Information coming soon.
